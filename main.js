...
module.exports = {"projectTypes":[{"type":"Personal Projects","summary":"I did these general projects apart from academic projects","code":0},{"type":"College Projects","summary":"I worked on these projects as part of my academics","code":1},{"type":"Basic Projects","summary":"Beginner-level work during my time at college.","code":2}],"projects":[{"title":"Save Current User Contacts","type":2,"description":["It is a web application where a user can save and view his contacts by logging in"],"summary":"A user can create an account and save his contacts and view them","image_path":"","demoURL":"","technologies":[]},{"title":"MoviesDb","type":2,"description":["This is a web application which fetches the info from an API and displays"],"summary":"This is a web application built on express js. It has just a basic API to request details of a movie by title. On requesting it this will call a third-party API and get the data. Based on this data we show it in a neat format","image_path":"","demoURL":"","technologies":[]},{"title":"Daksha School Web Page","type":2,"description":["It just has the static web pages "],"summary":"Daksha is a school I named, and started building static webpages for it as a part of learning HTML,CSS,Dootstrap, and some Javascript","image_path":"","demoURL":"","technologies":[]},{"title":"Premium Content","type":0,"description":["An angular and Node server-based application which show the premium content only for the logged-in users"],"summary":"","image_path":"","demoURL":"","technologies":[]},{"title":"Portfolio","type":0,"description":["An angular-based porfolio"],"summary":"","image_path":"","demoURL":"","technologies":[]},{"title":"Mini Cart","type":1,"description":["An android application"],"summary":"This is an e-commerce android application, Through which users can log in and make an order the generally available items","image_path":"","demoURL":"","technologies":[]},{"title":"Driver Drowsiness","type":1,"description":["This is an OpenCv based application for the detection of drivers drowsiness"],"summary":"","image_path":"","demoURL":"","technologies":[]}]};
